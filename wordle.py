...
#guesses is a 2D list 
#the list will be iterated through and each letter 
guesses_count = [[]] * 6
...
#indicators is a list storing all the indicator obj 
indicators = []
...
class Indicator:
    def __init__(self, x, y, letter):
        #initilizes variables such as color, size, position and letter
        self.x = x
        self.y = y
        self.text = letter
...
def check_guess(guess_to_check):
    #Goes through each letter and checks if it should be green yello or grey
...
def play_again():
    ...
    play_again_font = pygame.font.Font("assests/FreeSansBold.otf",40)
...
def delete_letter():
    #delete the last letter and adds it to the guess
    global current_guess_string, current_letter_bg_x
